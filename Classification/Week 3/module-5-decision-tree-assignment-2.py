...
def decision_tree_create(data, features, target, current_depth = 0, max_depth = 10):
    ...
    #need to keep track for the best feature to split on
    ...
    ## YOUR CODE HERE
    splitting_feature = best_splitting_feature(data,features,target) # find the best one
    
    # Split on the best feature that we found. 
    left_split = data[data[splitting_feature] == 0]
    right_split = data[data[splitting_feature] == 1]
    remaining_features.remove(splitting_feature) #Take out the one we splitted on
